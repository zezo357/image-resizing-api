...
describe('resize endpoint responses', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sharpObject.toFile(path_1.default.join(fileUtil_1.default.fullImagesPath(), imageName))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('gets the resize endpoint', function (done) {
        request
            .get("/resize?imgName=".concat(imageName, "&width=").concat(width, "&height=").concat(height))
